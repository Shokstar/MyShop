...
struct ContentView: View {
    var sellablevm: SellableViewModel
    let sellablesListVM :  SellableListViewModel
    var body: some View {
        VStack {
           
            //SellableListView(sellablesVM: sellablevm )

     SellableListView(sellablesListVM: sellablesListVM)
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        let sellableListVM = SellableListViewModel()
        ...
        return ContentView(sellablevm: sellablesVM, sellablesListVM: sellableListVM)
    }
}
